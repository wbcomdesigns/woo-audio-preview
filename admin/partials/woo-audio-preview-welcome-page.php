...
<div class="wbcom-tab-content">
	<div class="wbcom-welcome-main-wrapper">
		<div class="wbcom-welcome-head">
				...
				<?php esc_html_e( 'Woo Audio Preview provides a button on the single product page which will allow you to preview the Audio. The plugin provides a simple meta box to add sample audio file which can be previewed.', 'bp-add-group-types' ); ?>
				</p>
			...
			<div class="wbcom-support-info-wrap">
				<div class="wbcom-support-info-widgets">
					<div class="wbcom-support-inner">
						...
						<p><?php esc_html_e( 'Woo Audio Preview provides a button on the single product page which will allow you to preview the Audio. The plugin provides a simple meta box to add sample audio file which can be previewed.', 'bp-add-group-types' ); ?></p>
						<a href="<?php echo esc_url( 'https://wbcomdesigns.com/docs/woo-addons/woo-audio-preview/' ); ?>" class="button button-primary button-welcome-support" target="_blank"><?php esc_html_e( 'Read Documentation', 'bp-add-group-types' ); ?></a>
					</div>
				</div>
