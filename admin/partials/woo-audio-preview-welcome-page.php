...
<div class="wbcom-tab-content">
	<div class="wbcom-welcome-main-wrapper">
		<div class="wbcom-welcome-head">
			<h2 class="wbcom-welcome-title"><?php esc_html_e( 'Woo Audio Preview ', 'wc-audio-preview' ); ?></h2>
			<p class="wbcom-welcome-description"><?php esc_html_e( 'Woo Audio Preview provides a button on the single product page which will allow you to preview the Audio. The plugin provides a simple meta box to add sample audio file which can be previewed.', 'wc-audio-preview' ); ?></p>
