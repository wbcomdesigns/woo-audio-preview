...
<div class="wbcom-tab-content">
	<div class="wbcom-welcome-main-wrapper">
		<div class="wbcom-welcome-head">
			<h2><?php esc_html_e( '🎵 Audio Preview for WooCommerce', 'woo-audio-preview' ); ?></h2>
			<p class="wbcom-welcome-description">
				<?php esc_html_e( 'Add professional audio previews to your WooCommerce products. Let customers listen before they buy!', 'woo-audio-preview' ); ?>
			</p>
		</div>
