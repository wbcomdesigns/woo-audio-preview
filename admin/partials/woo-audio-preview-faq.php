<?php
/**
 * FAQ tab for the Audio Preview settings screen.
 *
 * Rendered inside the shared Wbcom_Settings_Page shell, using its native
 * <details>-based .wbcom-faq__item accordion so the tab matches every other
 * Wbcom plugin's FAQ with no bespoke markup, CSS or JS.
 *
...
Wbcom_Settings_Page::card_open(
	...
	__( 'Answers to the most common questions about Audio Preview for WooCommerce.', 'woo-audio-preview' )
);
?>
<details class="wbcom-faq__item">
	<summary><?php esc_html_e( 'What is the difference between Free and Pro versions?', 'woo-audio-preview' ); ?></summary>
...
<details class="wbcom-faq__item">
	<summary><?php esc_html_e( 'How do I add audio previews to my products?', 'woo-audio-preview' ); ?></summary>
...
<details class="wbcom-faq__item">
	<summary><?php esc_html_e( 'What audio formats are supported?', 'woo-audio-preview' ); ?></summary>
	...
	<p><strong><?php esc_html_e( 'CDN & Streaming Services:', 'woo-audio-preview' ); ?></strong></p>
	<ul>
...
<details class="wbcom-faq__item">
	<summary><?php esc_html_e( 'Does this work with multi-vendor marketplaces?', 'woo-audio-preview' ); ?></summary>
	...
	<p>
		<a href="https://wbcomdesigns.com/downloads/woo-audio-preview-pro/" target="_blank" rel="noopener noreferrer" class="button button-primary">
...
<details class="wbcom-faq__item">
	<summary><?php esc_html_e( 'Why can I only add 3 audio previews?', 'woo-audio-preview' ); ?></summary>
...
<details class="wbcom-faq__item">
	<summary><?php esc_html_e( 'How can I protect my audio files from downloading?', 'woo-audio-preview' ); ?></summary>
	...
	<ul>
		<li><?php esc_html_e( 'Audio watermarking', 'woo-audio-preview' ); ?></li>
		<li><?php esc_html_e( 'Voice-over protection', 'woo-audio-preview' ); ?></li>
		<li><?php esc_html_e( 'Time-limited previews', 'woo-audio-preview' ); ?></li>
		<li><?php esc_html_e( 'Secure streaming options', 'woo-audio-preview' ); ?></li>
		<li><?php esc_html_e( 'Right-click protection', 'woo-audio-preview' ); ?></li>
	</ul>
</details>

<details class="wbcom-faq__item">
	<summary><?php esc_html_e( 'Is the audio player mobile-friendly?', 'woo-audio-preview' ); ?></summary>
...
<details class="wbcom-faq__item">
	<summary><?php esc_html_e( 'Can I customize the player appearance?', 'woo-audio-preview' ); ?></summary>
	<p><strong><?php esc_html_e( 'Free Version:', 'woo-audio-preview' ); ?></strong></p>
