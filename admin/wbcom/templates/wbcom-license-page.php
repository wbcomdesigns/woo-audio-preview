...
<div class="wrap">
	...
	<div class="wbcom-wrap wbcom-plugin-wrapper">
		...
		<h4 class="wbcom-support-section"><?php esc_html_e( 'Plugin License', 'woo-audio-preview' ); ?></h4>
		<div class="wb-plugins-license-tables-wrap">
			...
			<table class="form-table wb-license-form-table desktop-license-headings">
				<thead>
					<tr>
						<th class="wb-product-th"><?php esc_html_e( 'Product', 'woo-audio-preview' ); ?></th>
						<th class="wb-version-th"><?php esc_html_e( 'Version', 'woo-audio-preview' ); ?></th>
						<th class="wb-key-th"><?php esc_html_e( 'Key', 'woo-audio-preview' ); ?></th>
						<th class="wb-status-th"><?php esc_html_e( 'Status', 'woo-audio-preview' ); ?></th>
						<th class="wb-action-th"><?php esc_html_e( 'Action', 'woo-audio-preview' ); ?></th>
					</tr>
				</thead>
			</table>
